...
const SimpleChart = ({
  ...
  data: Array<{ day: string; hours: number; color: string }>;
}) => {
              ...
              (item, index) =>
                `${item.color} ${
                  index === 0
                    ...
                    : (data
                        .slice(0, index)
                        .reduce((sum, prev) => sum + prev.hours, 0) /
                        total) *
                      360
                }deg ${
                  (data
          ...
          >
            <div style={{ height: 400 }}>
              {location ? (
                ...
                >
                  <Text type="secondary">
                    Clock in to see your location on the map.
                  </Text>
                </div>
              )}
            </div>
          ...
          >
            ...
            >
              <div style={{ marginTop: "20px" }}>
                <Badge
                  status={isClockedIn ? "success" : "error"}
                  text={
