...
import { Card, Table, Typography, Button, Space, Tag, Modal, Form, Input, InputNumber } from 'antd';
...
const perimeterData = [
  { key: '1', name: 'Main Office', radius: 500, lat: 34.0522, lng: -118.2437, status: 'Active' },
  { key: '2', name: 'North Campus', radius: 1000, lat: 34.0722, lng: -118.2537, status: 'Active' },
  { key: '3', name: 'Downtown Site', radius: 300, lat: 34.0422, lng: -118.2337, status: 'Inactive' },
];
    ...
    <div style={{ padding: '24px', backgroundColor: '#f7f8fc' }}>
      ...
      >
        <Form form={form} layout="vertical">
          <Form.Item name="name" label="Perimeter Name" rules={[{ required: true }]}>
            <Input />
          </Form.Item>
          <Form.Item name="radius" label="Radius (meters)" rules={[{ required: true }]}>
